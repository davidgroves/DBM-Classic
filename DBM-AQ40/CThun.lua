...
mod:SetRevision("20200730235534")
...
mod:RegisterEventsInCombat(
    "SPELL_CAST_START 26134 20604",
	"SPELL_CAST_SUCCESS 26134 20604",
...
mod:AddSetIconOption("SetIconOnEyeBeam", 26134, true, false, {4})
...
do
	...
	function mod:SPELL_CAST_START(args)
		...
		if spellName == EyeBeam and args:IsSrcTypeHostile() then
			self:BossTargetScanner(args.sourceGUID, "EyeBeamTarget", 0.05, 16)
		end
	end
end
